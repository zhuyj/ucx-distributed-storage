...
all:ucp_server.c ucp_client.c ucp_tag_server.c ucp_tag_client.c
	...
	gcc -Wall -o tag_server_read ucp_tag_server.c -I ${UCX_INSTALL_DIR}/include/ -L ${UCX_INSTALL_DIR}/lib/ -lucp -luct -lucs
